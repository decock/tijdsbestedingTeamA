package be.teama.client.contentzone;

import java.util.Date;
import java.util.List;

import tijdsbesteding.domain.api.snapshot.PersoonSnapshot;
import be.teama.client.service.TijdsbestedingService;
import be.teama.client.service.TijdsbestedingServiceAsync;
import be.teama.client.widgets.NormalFieldLabel;
